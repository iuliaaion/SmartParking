...
public class EnteringAgent extends Agent {
    protected void setup() {

        // add the ProcessRequestBehaviour() to all agents
        addBehaviour(new EnteringAgent.ProcessRequestBehaviour());
    ...
    private class ProcessRequestBehaviour extends CyclicBehaviour {
        ...
        public void action() {
            ...
            if (receivedMessage != null) {
                ...
                System.out.println("Car with registration number " + message.split("_")[0] + " entered  into the parking lot");
                ...
                messageToSend.setContent("A parking space has been occupied");
                send(messageToSend);
